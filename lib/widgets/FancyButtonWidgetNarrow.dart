...
class FancyButtonWidgetNarrow extends StatelessWidget {
  const FancyButtonWidgetNarrow({required this.route, required this.label, required this.imagen});
  final String route;
  final String label;
  final String imagen;
        ...
        Navigator.pushNamed(context, route);
          ...
          child: Ink(
            ...
            child: Stack(
              ...
              children: [
                Align(alignment: Alignment(0.5,0.25),
