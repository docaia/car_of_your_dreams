...
class MechanicRatingNarrow extends StatefulWidget {
  @override
  MechanicRatingNarrow();


  @override
  State<MechanicRatingNarrow> createState() => _MechanicRatingNarrowState();
}

class _MechanicRatingNarrowState extends State<MechanicRatingNarrow> {
  String? mechanicName;
  ...
  Widget build(BuildContext context) {
    MechanicInformation mn=MechanicInformation((value)=>mechanicName=value, "mech".tr, "name".tr, TextInputType.name, [FilteringTextInputFormatter.singleLineFormatter]);
    MechanicInformation mp=MechanicInformation((value)=>mechanicPhone=value, "phone".tr, "phone".tr, TextInputType.phone, [FilteringTextInputFormatter.digitsOnly]);
    MechanicInformation ml=MechanicInformation((value)=>mechanicLocation=value, "loc_disc".tr, "loc".tr, TextInputType.streetAddress, [FilteringTextInputFormatter.singleLineFormatter]);
    MechanicInformation ws=MechanicInformation((value)=>workshopName = value, "ws".tr, "ws".tr, TextInputType.name, [FilteringTextInputFormatter.singleLineFormatter]);
                      ...
                      Expanded(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text("mechTitle".tr, style: GoogleFonts.publicSans(
                              textStyle: TextStyle(
                                ...
                                children: <Widget>[
                                  Flexible(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text("spec".tr, style: TextStyle(fontWeight: FontWeight.w900)),
                                    ),
                                  ),
                                  SizedBox(width: 35,),
                                  Text("mechTakhasos".tr),
                                  Checkbox(
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Text('car'.tr, style: TextStyle(fontWeight: FontWeight.w900)),
                                  Padding(
                                    padding: const EdgeInsets.fromLTRB(50,0,10,0),
                                    child: Padding(
                                      padding: const EdgeInsets.fromLTRB(0,0,50,0),
                                      child: Row(children: <Widget>[
                                        Padding(
                                          ...
                                          child: DropdownButton<Manufacturers>(
                                              value: dropdownValue,
                                              hint:Text('manu'.tr, style: TextStyle(fontWeight: FontWeight.w700)),
                                        ...
                                        Padding(
                                          ...
                                          child: DropdownButton<CarModel>(
                                              value: dropdownModel,
                                              hint:Text('model'.tr, style: TextStyle(fontWeight: FontWeight.w700)),
                                        ...
                                        Padding(
                                          ...
                                          child: DropdownButton<String>(
                                              value: dropdownYear,
                                              hint:Text('year'.tr, style: TextStyle(fontWeight: FontWeight.w700)),
                            ...
                            Expanded(child:Padding(
                              ...
                              child: Align(
                                ...
                                child: ElevatedButton(
                                    ...
                                    child: Text('map'.tr, style: TextStyle(fontWeight: FontWeight.w900, color: Colors.black))
                                ),
                              ),
                            )),
                            Visibility(
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Text('opinion'.tr, style: TextStyle(fontWeight: FontWeight.w900)),
                                  RatingBar.builder(
                                    initialRating: 1,
                                    itemCount: 5,
                                    itemSize: 22,
                                    ...
                                    Padding(
                                      ...
                                      child: TextButton(onPressed: ()async{
                                        ...
                                        print("mechanic is $mechanicName");
                                          ...
                                          style: ButtonStyle(side: MaterialStateProperty.all(BorderSide() )),
                                          child: Text('send'.tr, style: GoogleFonts.aBeeZee(textStyle: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 20)),)),
                                    )
